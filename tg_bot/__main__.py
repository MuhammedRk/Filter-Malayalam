...
ഞങളുടെ Youtube Viedo അപ്‌ലോഡ് ആകുന്നത് [ഇതിൽ](https://t.me/Mo_Tech_bot) ആണ്... 
"""
...
*Main* ലഭ്യമായ commandകൾ:
 ...
 - /info: നിങ്ങളുടെ വേവരങ്ങൾക്കായി...!!
 - /help: ആവിശ്യമായ commandകൾ അറിയാൻ...!!
 - /donate: Botനെ കുറച്ചു അറിയാൻ...!!
 - /donate: Botന്റെ Key വേണങ്കിൽ...!!
{}
And the following:
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("😎ഹായ് മച്ചാൻ [എന്റെ യൂട്യൂബ് ചാനൽ സബ്സ്ക്രൈബ് ചെയ്തോ?](https://youtube.com/channel/UCmGBpXoM-OEm-FacOccVKgQ).")
